import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.CLEf5sEq.js";const b=JSON.parse('{"title":"Redis 命令集合","description":"","frontmatter":{},"headers":[],"relativePath":"column/LargeFrontEnd2023/103_Redis.md","filePath":"column/LargeFrontEnd2023/103_Redis.md"}'),e={name:"column/LargeFrontEnd2023/103_Redis.md"},l=p(`<h1 id="redis-命令集合" tabindex="-1">Redis 命令集合 <a class="header-anchor" href="#redis-命令集合" aria-label="Permalink to &quot;Redis 命令集合&quot;">​</a></h1><h2 id="key-键" tabindex="-1">Key（键） <a class="header-anchor" href="#key-键" aria-label="Permalink to &quot;Key（键）&quot;">​</a></h2><h3 id="del" tabindex="-1">DEL <a class="header-anchor" href="#del" aria-label="Permalink to &quot;DEL&quot;">​</a></h3><p>删除给定的一个或多个 key 。</p><p>不存在的 key 会被忽略。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DEL key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#  删除单个 key</span></span>
...
<span class="line"><span>(integer) 3</span></span></code></pre></div><h3 id="dump" tabindex="-1">DUMP <a class="header-anchor" href="#dump" aria-label="Permalink to &quot;DUMP&quot;">​</a></h3><p>序列化给定 key ，并返回被序列化的值，使用 RESTORE 命令可以将这个值反序列化为 Redis 键。</p><p>序列化生成的值有以下几个特点：</p><p>序列化的值不包括任何生存时间信息。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DUMP key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET greeting &quot;hello, dumping world!&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(nil)</span></span></code></pre></div><h3 id="exists" tabindex="-1">EXISTS <a class="header-anchor" href="#exists" aria-label="Permalink to &quot;EXISTS&quot;">​</a></h3><p>检查给定 key 是否存在。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>EXISTS key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET db &quot;redis&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 29996</span></span></code></pre></div><h3 id="expireat" tabindex="-1">EXPIREAT <a class="header-anchor" href="#expireat" aria-label="Permalink to &quot;EXPIREAT&quot;">​</a></h3><p>EXPIREAT 的作用和 EXPIRE 类似，都用于为 key 设置生存时间。</p><p>不同在于 EXPIREAT 命令接受的时间参数是 UNIX 时间戳(unix timestamp)。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>EXPIREAT key timestamp</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET cache www.google.com</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 45081860</span></span></code></pre></div><h3 id="keys" tabindex="-1">KEYS <a class="header-anchor" href="#keys" aria-label="Permalink to &quot;KEYS&quot;">​</a></h3><p>查找所有符合给定模式 pattern 的 key 。</p><p>特殊符号用 \\ 隔开</p><p>Warning</p><p>KEYS 的速度非常快，但在一个大的数据库中使用它仍然可能造成性能问题，如果你需要从一个数据集中查找特定的 key ，你最好还是用 Redis 的集合结构(set)来代替。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>KEYS pattern</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; MSET one 1 two 2 three 3 four 4  # 一次设置 4 个 key</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;apple&quot;</span></span></code></pre></div><h3 id="object" tabindex="-1">OBJECT <a class="header-anchor" href="#object" aria-label="Permalink to &quot;OBJECT&quot;">​</a></h3><p>OBJECT 命令允许从内部察看给定 key 的 Redis 对象。</p><p>OBJECT 命令有多个子命令：</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>OBJECT subcommand [arguments [arguments]]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET game &quot;COD&quot;           # 设置一个字符串</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; TTL mykey</span></span>
<span class="line"><span>(integer) -1</span></span></code></pre></div><h3 id="pexpire" tabindex="-1">PEXPIRE <a class="header-anchor" href="#pexpire" aria-label="Permalink to &quot;PEXPIRE&quot;">​</a></h3><p>这个命令和 EXPIRE 命令的作用类似，但是它以毫秒为单位设置 key 的生存时间，而不像 EXPIRE 命令那样，以秒为单位。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PEXPIRE key milliseconds</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET mykey &quot;Hello&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 1499</span></span></code></pre></div><h3 id="pexpireat" tabindex="-1">PEXPIREAT <a class="header-anchor" href="#pexpireat" aria-label="Permalink to &quot;PEXPIREAT&quot;">​</a></h3><p>这个命令和 EXPIREAT 命令类似，但它以毫秒为单位设置 key 的过期 unix 时间戳，而不是像 EXPIREAT 那样，以秒为单位。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PEXPIREAT key milliseconds-timestamp</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET mykey &quot;Hello&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 223157079318</span></span></code></pre></div><h3 id="pttl" tabindex="-1">PTTL <a class="header-anchor" href="#pttl" aria-label="Permalink to &quot;PTTL&quot;">​</a></h3><p>这个命令类似于 TTL 命令，但它以毫秒为单位返回 key 的剩余生存时间，而不是像 TTL 命令那样，以秒为单位。</p><p>Note</p><p>在 Redis 2.8 以前，当 key 不存在，或者 key 没有设置剩余生存时间时，命令都返回 -1 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PTTL key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 不存在的 key</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; PTTL key</span></span>
<span class="line"><span>(integer) 6179</span></span></code></pre></div><h3 id="randomkey" tabindex="-1">RANDOMKEY <a class="header-anchor" href="#randomkey" aria-label="Permalink to &quot;RANDOMKEY&quot;">​</a></h3><p>从当前数据库中随机返回(不删除)一个 key 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>RANDOMKEY</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 数据库不为空</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; RANDOMKEY</span></span>
<span class="line"><span>(nil)</span></span></code></pre></div><h3 id="rename" tabindex="-1">RENAME <a class="header-anchor" href="#rename" aria-label="Permalink to &quot;RENAME&quot;">​</a></h3><p>将 key 改名为 newkey 。</p><p>当 key 和 newkey 相同，或者 key 不存在时，返回一个错误。</p><p>当 newkey 已经存在时， RENAME 命令将覆盖旧值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>RENAME key newkey</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># key 存在且 newkey 不存在</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;lenovo&quot;</span></span></code></pre></div><h3 id="renamenx" tabindex="-1">RENAMENX <a class="header-anchor" href="#renamenx" aria-label="Permalink to &quot;RENAMENX&quot;">​</a></h3><p>当且仅当 newkey 不存在时，将 key 改名为 newkey 。</p><p>当 key 不存在时，返回一个错误。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>RENAMENX key newkey</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># newkey 不存在，改名成功</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;butterfly&quot;</span></span></code></pre></div><h3 id="restore" tabindex="-1">RESTORE <a class="header-anchor" href="#restore" aria-label="Permalink to &quot;RESTORE&quot;">​</a></h3><p>反序列化给定的序列化值，并将它和给定的 key 关联。</p><p>参数 ttl 以毫秒为单位为 key 设置生存时间；如果 ttl 为 0 ，那么不设置生存时间。</p><p>RESTORE 在执行反序列化之前会先对序列化值的 RDB 版本和数据校验和进行检查，如果 RDB 版本不相同或者数据不完整的话，那么 RESTORE 会拒绝进行反序列化，并返回一个错误。</p><p>更多信息可以参考 DUMP 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>RESTORE key ttl serialized-value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET greeting &quot;hello, dumping world!&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; DUMP greeting</span></span>
<span class="line"><span>&quot;\\x00\\x15hello, dumping world!\\x06\\x00E\\xa0Z\\x82\\xd8r\\xc1\\xde&quot;</span></span>
...
<span class="line"><span>4) &quot;1.5&quot;</span></span></code></pre></div><h3 id="ttl" tabindex="-1">TTL <a class="header-anchor" href="#ttl" aria-label="Permalink to &quot;TTL&quot;">​</a></h3><p>以秒为单位，返回给定 key 的剩余生存时间(TTL, time to live)。</p><p>Note</p><p>在 Redis 2.8 以前，当 key 不存在，或者 key 没有设置剩余生存时间时，命令都返回 -1 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>TTL key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 不存在的 key</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; FLUSHDB</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; TTL key</span></span>
<span class="line"><span>(integer) 10084</span></span></code></pre></div><h3 id="type" tabindex="-1">TYPE <a class="header-anchor" href="#type" aria-label="Permalink to &quot;TYPE&quot;">​</a></h3><p>返回 key 所储存的值的类型。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>TYPE key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 字符串</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; BITCOUNT bits</span></span>
<span class="line"><span>(integer) 2</span></span></code></pre></div><h3 id="bitop" tabindex="-1">BITOP <a class="header-anchor" href="#bitop" aria-label="Permalink to &quot;BITOP&quot;">​</a></h3><p>对一个或多个保存二进制位的字符串 key 进行位元操作，并将结果保存到 destkey 上。</p><p>operation 可以是 AND 、 OR 、 NOT 、 XOR 这四种操作中的任意一种：</p><p>除了 NOT 操作之外，其他操作都可以接受一个或多个 key 作为输入。</p><p>处理不同长度的字符串</p><p>当 BITOP 处理不同长度的字符串时，较短的那个字符串所缺少的部分会被看作 0 。</p><p>空的 key 也被看作是包含 0 的字符串序列。</p><p>Note</p><p>BITOP 的复杂度为 O(N) ，当处理大型矩阵(matrix)或者进行大数据量的统计时，最好将任务指派到附属节点(slave)进行，避免阻塞主节点。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BITOP operation destkey key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SETBIT bits-1 0 1        # bits-1 = 1001</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 1</span></span></code></pre></div><h3 id="decr" tabindex="-1">DECR <a class="header-anchor" href="#decr" aria-label="Permalink to &quot;DECR&quot;">​</a></h3><p>将 key 中储存的数字值减一。</p><p>如果 key 不存在，那么 key 的值会先被初始化为 0 ，然后再执行 DECR 操作。</p><p>如果值包含错误的类型，或字符串类型的值不能表示为数字，那么返回一个错误。</p><p>本操作的值限制在 64 位(bit)有符号数字表示之内。</p><p>关于递增(increment) / 递减(decrement)操作的更多信息，请参见 INCR 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DECR key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对存在的数字值 key 进行 DECR</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) -10</span></span></code></pre></div><h3 id="get" tabindex="-1">GET <a class="header-anchor" href="#get" aria-label="Permalink to &quot;GET&quot;">​</a></h3><p>返回 key 所关联的字符串值。</p><p>如果 key 不存在那么返回特殊值 nil 。</p><p>假如 key 储存的值不是字符串类型，返回一个错误，因为 GET 只能用于处理字符串值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>GET key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对不存在的 key 或字符串类型 key 进行 GET</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; GET db</span></span>
<span class="line"><span>(error) ERR Operation against a key holding the wrong kind of value</span></span></code></pre></div><h3 id="getbit" tabindex="-1">GETBIT <a class="header-anchor" href="#getbit" aria-label="Permalink to &quot;GETBIT&quot;">​</a></h3><p>对 key 所储存的字符串值，获取指定偏移量上的位(bit)。</p><p>当 offset 比字符串值的长度大，或者 key 不存在时，返回 0 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>GETBIT key offset</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对不存在的 key 或者不存在的 offset 进行 GETBIT， 返回 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; GETBIT bit 10086</span></span>
<span class="line"><span>(integer) 1</span></span></code></pre></div><h3 id="getrange" tabindex="-1">GETRANGE <a class="header-anchor" href="#getrange" aria-label="Permalink to &quot;GETRANGE&quot;">​</a></h3><p>返回 key 中字符串值的子字符串，字符串的截取范围由 start 和 end 两个偏移量决定(包括 start 和 end 在内)。</p><p>负数偏移量表示从字符串最后开始计数， -1 表示最后一个字符， -2 表示倒数第二个，以此类推。</p><p>GETRANGE 通过保证子字符串的值域(range)不超过实际字符串的值域来处理超出范围的值域请求。</p><p>Note</p><p>在 &lt;= 2.0 的版本里，GETRANGE 被叫作 SUBSTR。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>GETRANGE key start end</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET greeting &quot;hello, my friend&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;hello, my friend&quot;</span></span></code></pre></div><h3 id="getset" tabindex="-1">GETSET <a class="header-anchor" href="#getset" aria-label="Permalink to &quot;GETSET&quot;">​</a></h3><p>将给定 key 的值设为 value ，并返回 key 的旧值(old value)。</p><p>当 key 存在但不是字符串类型时，返回一个错误。</p><p>GETSET 可以和 INCR 组合使用，实现一个有原子性(atomic)复位操作的计数器(counter)。</p><p>举例来说，每次当某个事件发生时，进程可能对一个名为 mycount 的 key 调用 INCR 操作，通常我们还要在一个原子时间内同时完成获得计数器的值和将计数器值复位为 0 两个操作。</p><p>可以用命令 GETSET mycounter 0 来实现这一目标。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>GETSET key value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; GETSET db mongodb    # 没有旧值，返回 nil</span></span>
<span class="line"><span>(nil)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; GET db</span></span>
...
<span class="line"><span>&quot;21&quot;</span></span></code></pre></div><h3 id="incrby" tabindex="-1">INCRBY <a class="header-anchor" href="#incrby" aria-label="Permalink to &quot;INCRBY&quot;">​</a></h3><p>将 key 所储存的值加上增量 increment 。</p><p>如果 key 不存在，那么 key 的值会先被初始化为 0 ，然后再执行 INCRBY 命令。</p><p>如果值包含错误的类型，或字符串类型的值不能表示为数字，那么返回一个错误。</p><p>本操作的值限制在 64 位(bit)有符号数字表示之内。</p><p>关于递增(increment) / 递减(decrement)操作的更多信息，参见 INCR 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>INCRBY key increment</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># key 存在且是数字值</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(error) ERR value is not an integer or out of range</span></span></code></pre></div><h3 id="incrbyfloat" tabindex="-1">INCRBYFLOAT <a class="header-anchor" href="#incrbyfloat" aria-label="Permalink to &quot;INCRBYFLOAT&quot;">​</a></h3><p>为 key 中所储存的值加上浮点数增量 increment 。</p><p>如果 key 不存在，那么 INCRBYFLOAT 会先将 key 的值设为 0 ，再执行加法操作。</p><p>如果命令执行成功，那么 key 的值会被更新为（执行加法之后的）新值，并且新值会以字符串的形式返回给调用者。</p><p>无论是 key 的值，还是增量 increment ，都可以使用像 2.0e7 、 3e5 、 90e-2 那样的指数符号(exponential notation)来表示，但是，执行 INCRBYFLOAT 命令之后的值总是以同样的形式储存，也即是，它们总是由一个数字，一个（可选的）小数点和一个任意位的小数部分组成（比如 3.14 、 69.768 ，诸如此类)，小数部分尾随的 0 会被移除，如果有需要的话，还会将浮点数改为整数（比如 3.0 会被保存成 3 ）。</p><p>除此之外，无论加法计算所得的浮点数的实际精度有多长， INCRBYFLOAT 的计算结果也最多只能表示小数点的后十七位。</p><p>当以下任意一个条件发生时，返回一个错误：</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>INCRBYFLOAT key increment</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 值和增量都不是指数符号</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;4&quot;</span></span></code></pre></div><h3 id="mget" tabindex="-1">MGET <a class="header-anchor" href="#mget" aria-label="Permalink to &quot;MGET&quot;">​</a></h3><p>返回所有(一个或多个)给定 key 的值。</p><p>如果给定的 key 里面，有某个 key 不存在，那么这个 key 返回特殊值 nil 。因此，该命令永不失败。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>MGET key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET redis redis.com</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>1) &quot;redis.com&quot;</span></span>
<span class="line"><span>2) &quot;mongodb.org&quot;</span></span>
<span class="line"><span>3) (nil)</span></span></code></pre></div><h3 id="mset" tabindex="-1">MSET <a class="header-anchor" href="#mset" aria-label="Permalink to &quot;MSET&quot;">​</a></h3><p>同时设置一个或多个 key-value 对。</p><p>如果某个给定 key 已经存在，那么 MSET 会用新值覆盖原来的旧值，如果这不是你所希望的效果，请考虑使用 MSETNX 命令：它只会在所有给定 key 都不存在的情况下进行设置操作。</p><p>MSET 是一个原子性(atomic)操作，所有给定 key 都会在同一时间内被设置，某些给定 key 被更新而另一些给定 key 没有改变的情况，不可能发生。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>MSET key value [key value ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; MSET date &quot;2012.3.30&quot; time &quot;11:00 a.m.&quot; weather &quot;sunny&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;google.com&quot;</span></span></code></pre></div><h3 id="msetnx" tabindex="-1">MSETNX <a class="header-anchor" href="#msetnx" aria-label="Permalink to &quot;MSETNX&quot;">​</a></h3><p>同时设置一个或多个 key-value 对，当且仅当所有给定 key 都不存在。</p><p>即使只有一个给定 key 已存在， MSETNX 也会拒绝执行所有给定 key 的设置操作。</p><p>MSETNX 是原子性的，因此它可以用作设置多个不同 key 表示不同字段(field)的唯一性逻辑对象(unique logic object)，所有字段要么全被设置，要么全不被设置。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>MSETNX key value [key value ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对不存在的 key 进行 MSETNX</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;MySQL&quot;</span></span></code></pre></div><h3 id="psetex" tabindex="-1">PSETEX <a class="header-anchor" href="#psetex" aria-label="Permalink to &quot;PSETEX&quot;">​</a></h3><p>这个命令和 SETEX 命令相似，但它以毫秒为单位设置 key 的生存时间，而不是像 SETEX 命令那样，以秒为单位。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PSETEX key milliseconds value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; PSETEX mykey 1000 &quot;Hello&quot;</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 997   # 这是 EX 参数设置的值</span></span></code></pre></div><h3 id="setbit" tabindex="-1">SETBIT <a class="header-anchor" href="#setbit" aria-label="Permalink to &quot;SETBIT&quot;">​</a></h3><p>对 key 所储存的字符串值，设置或清除指定偏移量上的位(bit)。</p><p>位的设置或清除取决于 value 参数，可以是 0 也可以是 1 。</p><p>当 key 不存在时，自动生成一个新的字符串值。</p><p>字符串会进行伸展(grown)以确保它可以将 value 保存在指定的偏移量上。当字符串值进行伸展时，空白位置以 0 填充。</p><p>offset 参数必须大于或等于 0 ，小于 2^32 (bit 映射被限制在 512 MB 之内)。</p><p>Warning</p><p>对使用大的 offset 的 SETBIT 操作来说，内存分配可能造成 Redis 服务器被阻塞。具体参考 SETRANGE 命令，warning(警告)部分。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SETBIT key offset value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SETBIT bit 10086 1</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; GETBIT bit 10086</span></span>
<span class="line"><span>(integer) 1</span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="setex" tabindex="-1">SETEX <a class="header-anchor" href="#setex" aria-label="Permalink to &quot;SETEX&quot;">​</a></h3><p>将值 value 关联到 key ，并将 key 的生存时间设为 seconds (以秒为单位)。</p><p>如果 key 已经存在， SETEX 命令将覆写旧值。</p><p>这个命令类似于以下两个命令：</p><p>不同之处是， SETEX 是一个原子性(atomic)操作，关联值和设置生存时间两个动作会在同一时间内完成，该命令在 Redis 用作缓存时，非常实用。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SETEX key seconds value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SET key value</span></span>
<span class="line"><span>EXPIRE key seconds  # 设置生存时间</span></span></code></pre></div><h3 id="setnx" tabindex="-1">SETNX <a class="header-anchor" href="#setnx" aria-label="Permalink to &quot;SETNX&quot;">​</a></h3><p>将 key 的值设为 value ，当且仅当 key 不存在。</p><p>若给定的 key 已经存在，则 SETNX 不做任何动作。</p><p>SETNX 是『SET if Not eXists』(如果不存在，则 SET)的简写。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SETNX key value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; EXISTS job                # job 不存在</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;\\x00\\x00\\x00\\x00\\x00Redis!&quot;</span></span></code></pre></div><h3 id="strlen" tabindex="-1">STRLEN <a class="header-anchor" href="#strlen" aria-label="Permalink to &quot;STRLEN&quot;">​</a></h3><p>返回 key 所储存的字符串值的长度。</p><p>当 key 储存的不是字符串值时，返回一个错误。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>STRLEN key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 获取字符串的长度</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h2 id="hash-哈希表" tabindex="-1">Hash（哈希表） <a class="header-anchor" href="#hash-哈希表" aria-label="Permalink to &quot;Hash（哈希表）&quot;">​</a></h2><h3 id="hdel" tabindex="-1">HDEL <a class="header-anchor" href="#hdel" aria-label="Permalink to &quot;HDEL&quot;">​</a></h3><p>删除哈希表 key 中的一个或多个指定域，不存在的域将被忽略。</p><p>Note</p><p>在Redis2.4以下的版本里， HDEL 每次只能删除单个域，如果你需要在一个原子时间内删除多个域，请将命令包含在 MULTI / EXEC 块内。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HDEL key field [field ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 测试数据</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>2) &quot;dog&quot;</span></span></code></pre></div><h3 id="hexists" tabindex="-1">HEXISTS <a class="header-anchor" href="#hexists" aria-label="Permalink to &quot;HEXISTS&quot;">​</a></h3><p>查看哈希表 key 中，给定域 field 是否存在。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HEXISTS key field</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HEXISTS phone myphone</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 1</span></span></code></pre></div><h3 id="hget" tabindex="-1">HGET <a class="header-anchor" href="#hget" aria-label="Permalink to &quot;HGET&quot;">​</a></h3><p>返回哈希表 key 中给定域 field 的值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HGET key field</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 域存在</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(nil)</span></span></code></pre></div><h3 id="hgetall" tabindex="-1">HGETALL <a class="header-anchor" href="#hgetall" aria-label="Permalink to &quot;HGETALL&quot;">​</a></h3><p>返回哈希表 key 中，所有的域和值。</p><p>在返回值里，紧跟每个域名(field name)之后是域的值(value)，所以返回值的长度是哈希表大小的两倍。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HGETALL key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HSET people jack &quot;Jack Sparrow&quot;</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>4) &quot;Forrest Gump&quot;</span></span></code></pre></div><h3 id="hincrby" tabindex="-1">HINCRBY <a class="header-anchor" href="#hincrby" aria-label="Permalink to &quot;HINCRBY&quot;">​</a></h3><p>为哈希表 key 中的域 field 的值加上增量 increment 。</p><p>增量也可以为负数，相当于对给定域进行减法操作。</p><p>如果 key 不存在，一个新的哈希表被创建并执行 HINCRBY 命令。</p><p>如果域 field 不存在，那么在执行命令前，域的值被初始化为 0 。</p><p>对一个储存字符串值的域 field 执行 HINCRBY 命令将造成一个错误。</p><p>本操作的值被限制在 64 位(bit)有符号数字表示之内。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HINCRBY key field increment</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># increment 为正数</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;hello,world&quot;</span></span></code></pre></div><h3 id="hincrbyfloat" tabindex="-1">HINCRBYFLOAT <a class="header-anchor" href="#hincrbyfloat" aria-label="Permalink to &quot;HINCRBYFLOAT&quot;">​</a></h3><p>为哈希表 key 中的域 field 加上浮点数增量 increment 。</p><p>如果哈希表中没有域 field ，那么 HINCRBYFLOAT 会先将域 field 的值设为 0 ，然后再执行加法操作。</p><p>如果键 key 不存在，那么 HINCRBYFLOAT 会先创建一个哈希表，再创建域 field ，最后再执行加法操作。</p><p>当以下任意一个条件发生时，返回一个错误：</p><p>HINCRBYFLOAT 命令的详细功能和 INCRBYFLOAT 命令类似，请查看 INCRBYFLOAT 命令获取更多相关信息。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HINCRBYFLOAT key field increment</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 值和增量都是普通小数</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>4) &quot;4.5&quot;</span></span></code></pre></div><h3 id="hkeys" tabindex="-1">HKEYS <a class="header-anchor" href="#hkeys" aria-label="Permalink to &quot;HKEYS&quot;">​</a></h3><p>返回哈希表 key 中的所有域。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HKEYS key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 哈希表非空</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(empty list or set)</span></span></code></pre></div><h3 id="hlen" tabindex="-1">HLEN <a class="header-anchor" href="#hlen" aria-label="Permalink to &quot;HLEN&quot;">​</a></h3><p>返回哈希表 key 中域的数量。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HLEN key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HSET db redis redis.com</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; HLEN db</span></span>
<span class="line"><span>(integer) 3</span></span></code></pre></div><h3 id="hmget" tabindex="-1">HMGET <a class="header-anchor" href="#hmget" aria-label="Permalink to &quot;HMGET&quot;">​</a></h3><p>返回哈希表 key 中，一个或多个给定域的值。</p><p>如果给定的域不存在于哈希表，那么返回一个 nil 值。</p><p>因为不存在的 key 被当作一个空哈希表来处理，所以对一个不存在的 key 进行 HMGET 操作将返回一个只带有 nil 值的表。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HMGET key field [field ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HMSET pet dog &quot;doudou&quot; cat &quot;nounou&quot;    # 一次设置多个域</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>3) (nil)                                      # 不存在的域返回nil值</span></span></code></pre></div><h3 id="hmset" tabindex="-1">HMSET <a class="header-anchor" href="#hmset" aria-label="Permalink to &quot;HMSET&quot;">​</a></h3><p>同时将多个 field-value (域-值)对设置到哈希表 key 中。</p><p>此命令会覆盖哈希表中已存在的域。</p><p>如果 key 不存在，一个空哈希表被创建并执行 HMSET 操作。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HMSET key field value [field value ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HMSET website google www.google.com yahoo www.yahoo.com</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;www.yahoo.com&quot;</span></span></code></pre></div><h3 id="hset" tabindex="-1">HSET <a class="header-anchor" href="#hset" aria-label="Permalink to &quot;HSET&quot;">​</a></h3><p>将哈希表 key 中的域 field 的值设为 value 。</p><p>如果 key 不存在，一个新的哈希表被创建并进行 HSET 操作。</p><p>如果域 field 已经存在于哈希表中，旧值将被覆盖。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HSET key field value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HSET website google &quot;www.g.cn&quot;       # 设置一个新域</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; HSET website google &quot;www.google.com&quot; # 覆盖一个旧域</span></span>
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="hsetnx" tabindex="-1">HSETNX <a class="header-anchor" href="#hsetnx" aria-label="Permalink to &quot;HSETNX&quot;">​</a></h3><p>将哈希表 key 中的域 field 的值设置为 value ，当且仅当域 field 不存在。</p><p>若域 field 已经存在，该操作无效。</p><p>如果 key 不存在，一个新哈希表被创建并执行 HSETNX 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HSETNX key field value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; HSETNX nosql key-value-store redis</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; HSETNX nosql key-value-store redis       # 操作无效，域 key-value-store 已存在</span></span>
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="hvals" tabindex="-1">HVALS <a class="header-anchor" href="#hvals" aria-label="Permalink to &quot;HVALS&quot;">​</a></h3><p>返回哈希表 key 中所有域的值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HVALS key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 非空哈希表</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; HMSET website google www.google.com yahoo www.yahoo.com</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>2) &quot;update system...&quot;                    # 弹出元素所属的值</span></span></code></pre></div><h3 id="brpop" tabindex="-1">BRPOP <a class="header-anchor" href="#brpop" aria-label="Permalink to &quot;BRPOP&quot;">​</a></h3><p>BRPOP 是列表的阻塞式(blocking)弹出原语。</p><p>它是 RPOP 命令的阻塞版本，当给定列表内没有任何元素可供弹出的时候，连接将被 BRPOP 命令阻塞，直到等待超时或发现可弹出元素为止。</p><p>当给定多个 key 参数时，按参数 key 的先后顺序依次检查各个列表，弹出第一个非空列表的尾部元素。</p><p>关于阻塞操作的更多信息，请查看 BLPOP 命令， BRPOP 除了弹出元素的位置和 BLPOP 不同之外，其他表现一致。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BRPOP key [key ...] timeout</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; LLEN course</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>2) &quot;c++101&quot;             # 弹出元素的值</span></span></code></pre></div><h3 id="brpoplpush" tabindex="-1">BRPOPLPUSH <a class="header-anchor" href="#brpoplpush" aria-label="Permalink to &quot;BRPOPLPUSH&quot;">​</a></h3><p>BRPOPLPUSH 是 RPOPLPUSH 的阻塞版本，当给定列表 source 不为空时， BRPOPLPUSH 的表现和 RPOPLPUSH 一样。</p><p>当列表 source 为空时， BRPOPLPUSH 命令将阻塞连接，直到等待超时，或有另一个客户端对 source 执行 LPUSH 或 RPUSH 命令为止。</p><p>超时参数 timeout 接受一个以秒为单位的数字作为值。超时参数设为 0 表示阻塞时间可以无限期延长(block indefinitely) 。</p><p>更多相关信息，请参考 RPOPLPUSH 命令。</p><p>参考 RPOPLPUSH 命令的『安全队列』模式。</p><p>参考 RPOPLPUSH 命令的『循环列表』模式。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BRPOPLPUSH source destination timeout</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 非空列表</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(nil)</span></span>
<span class="line"><span>(1.34s)</span></span></code></pre></div><h3 id="lindex" tabindex="-1">LINDEX <a class="header-anchor" href="#lindex" aria-label="Permalink to &quot;LINDEX&quot;">​</a></h3><p>返回列表 key 中，下标为 index 的元素。</p><p>下标(index)参数 start 和 stop 都以 0 为底，也就是说，以 0 表示列表的第一个元素，以 1 表示列表的第二个元素，以此类推。</p><p>你也可以使用负数下标，以 -1 表示列表的最后一个元素， -2 表示列表的倒数第二个元素，以此类推。</p><p>如果 key 不是列表类型，返回一个错误。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LINDEX key index</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; LPUSH mylist &quot;World&quot;</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(nil)</span></span></code></pre></div><h3 id="linsert" tabindex="-1">LINSERT <a class="header-anchor" href="#linsert" aria-label="Permalink to &quot;LINSERT&quot;">​</a></h3><p>将值 value 插入到列表 key 当中，位于值 pivot 之前或之后。</p><p>当 pivot 不存在于列表 key 时，不执行任何操作。</p><p>当 key 不存在时， key 被视为空列表，不执行任何操作。</p><p>如果 key 不是列表类型，返回一个错误。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LINSERT key BEFORE|AFTER pivot value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; RPUSH mylist &quot;Hello&quot;</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 0                                      # 失败</span></span></code></pre></div><h3 id="llen" tabindex="-1">LLEN <a class="header-anchor" href="#llen" aria-label="Permalink to &quot;LLEN&quot;">​</a></h3><p>返回列表 key 的长度。</p><p>如果 key 不存在，则 key 被解释为一个空列表，返回 0 .</p><p>如果 key 不是列表类型，返回一个错误。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LLEN key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 空列表</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; LLEN job</span></span>
<span class="line"><span>(integer) 2</span></span></code></pre></div><h3 id="lpop" tabindex="-1">LPOP <a class="header-anchor" href="#lpop" aria-label="Permalink to &quot;LPOP&quot;">​</a></h3><p>移除并返回列表 key 的头元素。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LPOP key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; LLEN course</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; RPUSH course algorithm001</span></span>
<span class="line"><span>(integer) 1</span></span>
...
<span class="line"><span>&quot;algorithm001&quot;</span></span></code></pre></div><h3 id="lpush" tabindex="-1">LPUSH <a class="header-anchor" href="#lpush" aria-label="Permalink to &quot;LPUSH&quot;">​</a></h3><p>将一个或多个值 value 插入到列表 key 的表头</p><p>如果有多个 value 值，那么各个 value 值按从左到右的顺序依次插入到表头： 比如说，对空列表 mylist 执行命令 LPUSH mylist a b c ，列表的值将是 c b a ，这等同于原子性地执行 LPUSH mylist a 、 LPUSH mylist b 和 LPUSH mylist c 三个命令。</p><p>如果 key 不存在，一个空列表会被创建并执行 LPUSH 操作。</p><p>当 key 存在但不是列表类型时，返回一个错误。</p><p>Note</p><p>在Redis 2.4版本以前的 LPUSH 命令，都只接受单个 value 值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LPUSH key value [value ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 加入单个元素</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>3) &quot;a&quot;</span></span></code></pre></div><h3 id="lpushx" tabindex="-1">LPUSHX <a class="header-anchor" href="#lpushx" aria-label="Permalink to &quot;LPUSHX&quot;">​</a></h3><p>将值 value 插入到列表 key 的表头，当且仅当 key 存在并且是一个列表。</p><p>和 LPUSH 命令相反，当 key 不存在时， LPUSHX 命令什么也不做。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LPUSHX key value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对空列表执行 LPUSHX</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>1) &quot;lisp&quot;</span></span>
<span class="line"><span>2) &quot;scheme&quot;</span></span></code></pre></div><h3 id="lrem" tabindex="-1">LREM <a class="header-anchor" href="#lrem" aria-label="Permalink to &quot;LREM&quot;">​</a></h3><p>根据参数 count 的值，移除列表中与参数 value 相等的元素。</p><p>count 的值可以是以下几种：</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LREM key count value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 先创建一个表，内容排列是</span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="lset" tabindex="-1">LSET <a class="header-anchor" href="#lset" aria-label="Permalink to &quot;LSET&quot;">​</a></h3><p>将列表 key 下标为 index 的元素的值设置为 value 。</p><p>当 index 参数超出范围，或对一个空列表( key 不存在)进行 LSET 时，返回一个错误。</p><p>关于列表下标的更多信息，请参考 LINDEX 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LSET key index value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对空列表(key 不存在)进行 LSET</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>4) &quot;2&quot;</span></span></code></pre></div><h3 id="rpush" tabindex="-1">RPUSH <a class="header-anchor" href="#rpush" aria-label="Permalink to &quot;RPUSH&quot;">​</a></h3><p>将一个或多个值 value 插入到列表 key 的表尾(最右边)。</p><p>如果有多个 value 值，那么各个 value 值按从左到右的顺序依次插入到表尾：比如对一个空列表 mylist 执行 RPUSH mylist a b c ，得出的结果列表为 a b c ，等同于执行命令 RPUSH mylist a 、 RPUSH mylist b 、 RPUSH mylist c 。</p><p>如果 key 不存在，一个空列表会被创建并执行 RPUSH 操作。</p><p>当 key 存在但不是列表类型时，返回一个错误。</p><p>Note</p><p>在 Redis 2.4 版本以前的 RPUSH 命令，都只接受单个 value 值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>RPUSH key value [value ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 添加单个元素</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>1) &quot;a&quot;</span></span>
<span class="line"><span>2) &quot;b&quot;</span></span>
<span class="line"><span>3) &quot;c&quot;</span></span></code></pre></div><h3 id="rpushx" tabindex="-1">RPUSHX <a class="header-anchor" href="#rpushx" aria-label="Permalink to &quot;RPUSHX&quot;">​</a></h3><p>将值 value 插入到列表 key 的表尾，当且仅当 key 存在并且是一个列表。</p><p>和 RPUSH 命令相反，当 key 不存在时， RPUSHX 命令什么也不做。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>RPUSHX key value</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># key不存在</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; LLEN greet</span></span>
<span class="line"><span>(integer) 0</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>2) &quot;hello&quot;</span></span></code></pre></div><h2 id="set-集合" tabindex="-1">Set（集合） <a class="header-anchor" href="#set-集合" aria-label="Permalink to &quot;Set（集合）&quot;">​</a></h2><h3 id="sadd" tabindex="-1">SADD <a class="header-anchor" href="#sadd" aria-label="Permalink to &quot;SADD&quot;">​</a></h3><p>将一个或多个 member 元素加入到集合 key 当中，已经存在于集合的 member 元素将被忽略。</p><p>假如 key 不存在，则创建一个只包含 member 元素作成员的集合。</p><p>当 key 不是集合类型时，返回一个错误。</p><p>Note</p><p>在Redis2.4版本以前， SADD 只接受单个 member 值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SADD key member [member ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 添加单个元素</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>3) &quot;tianya.cn&quot;</span></span></code></pre></div><h3 id="scard" tabindex="-1">SCARD <a class="header-anchor" href="#scard" aria-label="Permalink to &quot;SCARD&quot;">​</a></h3><p>返回集合 key 的基数(集合中元素的数量)。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SCARD key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SADD tool pc printer phone</span></span>
<span class="line"><span>(integer) 3</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="sdiff" tabindex="-1">SDIFF <a class="header-anchor" href="#sdiff" aria-label="Permalink to &quot;SDIFF&quot;">​</a></h3><p>返回一个集合的全部成员，该集合是所有给定集合之间的差集。</p><p>不存在的 key 被视为空集。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SDIFF key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS peter&#39;s_movies</span></span>
...
<span class="line"><span>1) &quot;bet man&quot;</span></span>
<span class="line"><span>2) &quot;start war&quot;</span></span></code></pre></div><h3 id="sdiffstore" tabindex="-1">SDIFFSTORE <a class="header-anchor" href="#sdiffstore" aria-label="Permalink to &quot;SDIFFSTORE&quot;">​</a></h3><p>这个命令的作用和 SDIFF 类似，但它将结果保存到 destination 集合，而不是简单地返回结果集。</p><p>如果 destination 集合已经存在，则将其覆盖。</p><p>destination 可以是 key 本身。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SDIFFSTORE destination key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS joe&#39;s_movies</span></span>
<span class="line"><span>1) &quot;hi, lady&quot;</span></span>
<span class="line"><span>2) &quot;Fast Five&quot;</span></span>
<span class="line"><span>3) &quot;2012&quot;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>1) &quot;hi, lady&quot;</span></span>
<span class="line"><span>2) &quot;Fast Five&quot;</span></span></code></pre></div><h3 id="sinter" tabindex="-1">SINTER <a class="header-anchor" href="#sinter" aria-label="Permalink to &quot;SINTER&quot;">​</a></h3><p>返回一个集合的全部成员，该集合是所有给定集合的交集。</p><p>不存在的 key 被视为空集。</p><p>当给定集合当中有一个空集时，结果也为空集(根据集合运算定律)。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SINTER key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS group_1</span></span>
...
<span class="line"><span>1) &quot;JACK&quot;</span></span></code></pre></div><h3 id="sinterstore" tabindex="-1">SINTERSTORE <a class="header-anchor" href="#sinterstore" aria-label="Permalink to &quot;SINTERSTORE&quot;">​</a></h3><p>这个命令类似于 SINTER 命令，但它将结果保存到 destination 集合，而不是简单地返回结果集。</p><p>如果 destination 集合已经存在，则将其覆盖。</p><p>destination 可以是 key 本身。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SINTERSTORE destination key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS songs</span></span>
...
<span class="line"><span>1) &quot;good bye joe&quot;</span></span></code></pre></div><h3 id="sismember" tabindex="-1">SISMEMBER <a class="header-anchor" href="#sismember" aria-label="Permalink to &quot;SISMEMBER&quot;">​</a></h3><p>判断 member 元素是否集合 key 的成员。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SISMEMBER key member</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS joe&#39;s_movies</span></span>
<span class="line"><span>1) &quot;hi, lady&quot;</span></span>
<span class="line"><span>2) &quot;Fast Five&quot;</span></span>
<span class="line"><span>3) &quot;2012&quot;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 1</span></span></code></pre></div><h3 id="smembers" tabindex="-1">SMEMBERS <a class="header-anchor" href="#smembers" aria-label="Permalink to &quot;SMEMBERS&quot;">​</a></h3><p>返回集合 key 中的所有成员。</p><p>不存在的 key 被视为空集合。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SMEMBERS key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># key 不存在或集合为空</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>3) &quot;Clojure&quot;</span></span></code></pre></div><h3 id="smove" tabindex="-1">SMOVE <a class="header-anchor" href="#smove" aria-label="Permalink to &quot;SMOVE&quot;">​</a></h3><p>将 member 元素从 source 集合移动到 destination 集合。</p><p>SMOVE 是原子性操作。</p><p>如果 source 集合不存在或不包含指定的 member 元素，则 SMOVE 命令不执行任何操作，仅返回 0 。否则， member 元素从 source 集合中被移除，并添加到 destination 集合中去。</p><p>当 destination 集合已经包含 member 元素时， SMOVE 命令只是简单地将 source 集合中的 member 元素删除。</p><p>当 source 或 destination 不是集合类型时，返回一个错误。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SMOVE source destination member</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS songs</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; SMEMBERS my_songs</span></span>
<span class="line"><span>1) &quot;Believe Me&quot;</span></span></code></pre></div><h3 id="spop" tabindex="-1">SPOP <a class="header-anchor" href="#spop" aria-label="Permalink to &quot;SPOP&quot;">​</a></h3><p>移除并返回集合中的一个随机元素。</p><p>如果只想获取一个随机元素，但不想该元素从集合中被移除的话，可以使用 SRANDMEMBER 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SPOP key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS db</span></span>
<span class="line"><span>1) &quot;MySQL&quot;</span></span>
<span class="line"><span>2) &quot;MongoDB&quot;</span></span>
<span class="line"><span>3) &quot;Redis&quot;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; SMEMBERS db</span></span>
<span class="line"><span>1) &quot;MongoDB&quot;</span></span></code></pre></div><h3 id="srandmember" tabindex="-1">SRANDMEMBER <a class="header-anchor" href="#srandmember" aria-label="Permalink to &quot;SRANDMEMBER&quot;">​</a></h3><p>如果命令执行时，只提供了 key 参数，那么返回集合中的一个随机元素。</p><p>从 Redis 2.6 版本开始， SRANDMEMBER 命令接受可选的 count 参数：</p><p>该操作和 SPOP 相似，但 SPOP 将随机元素从集合中移除并返回，而 SRANDMEMBER 则仅仅返回随机元素，而不对集合进行任何改动。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SRANDMEMBER key [count]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 添加元素</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(empty list or set)</span></span></code></pre></div><h3 id="srem" tabindex="-1">SREM <a class="header-anchor" href="#srem" aria-label="Permalink to &quot;SREM&quot;">​</a></h3><p>移除集合 key 中的一个或多个 member 元素，不存在的 member 元素会被忽略。</p><p>当 key 不是集合类型，返回一个错误。</p><p>Note</p><p>在 Redis 2.4 版本以前， SREM 只接受单个 member 值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SREM key member [member ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 测试数据</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; SMEMBERS languages</span></span>
<span class="line"><span>(empty list or set)</span></span></code></pre></div><h3 id="sunion" tabindex="-1">SUNION <a class="header-anchor" href="#sunion" aria-label="Permalink to &quot;SUNION&quot;">​</a></h3><p>返回一个集合的全部成员，该集合是所有给定集合的并集。</p><p>不存在的 key 被视为空集。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SUNION key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS songs</span></span>
<span class="line"><span>1) &quot;Billie Jean&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; SMEMBERS my_songs</span></span>
...
<span class="line"><span>1) &quot;Billie Jean&quot;</span></span>
<span class="line"><span>2) &quot;Believe Me&quot;</span></span></code></pre></div><h3 id="sunionstore" tabindex="-1">SUNIONSTORE <a class="header-anchor" href="#sunionstore" aria-label="Permalink to &quot;SUNIONSTORE&quot;">​</a></h3><p>这个命令类似于 SUNION 命令，但它将结果保存到 destination 集合，而不是简单地返回结果集。</p><p>如果 destination 已经存在，则将其覆盖。</p><p>destination 可以是 key 本身。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SUNIONSTORE destination key [key ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SMEMBERS NoSQL</span></span>
...
<span class="line"><span>4) &quot;9&quot;</span></span>
<span class="line"><span>5) &quot;google.com&quot;</span></span>
<span class="line"><span>6) &quot;10&quot;</span></span></code></pre></div><h3 id="zcard" tabindex="-1">ZCARD <a class="header-anchor" href="#zcard" aria-label="Permalink to &quot;ZCARD&quot;">​</a></h3><p>返回有序集 key 的基数。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZCARD key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis &gt; ZADD salary 2000 tom    # 添加一个成员</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="zcount" tabindex="-1">ZCOUNT <a class="header-anchor" href="#zcount" aria-label="Permalink to &quot;ZCOUNT&quot;">​</a></h3><p>返回有序集 key 中， score 值在 min 和 max 之间(默认包括 score 值等于 min 或 max )的成员的数量。</p><p>关于参数 min 和 max 的详细使用方法，请参考 ZRANGEBYSCORE 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZCOUNT key min max</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZRANGE salary 0 -1 WITHSCORES    # 测试数据</span></span>
...
<span class="line"><span>(integer) 2</span></span></code></pre></div><h3 id="zincrby" tabindex="-1">ZINCRBY <a class="header-anchor" href="#zincrby" aria-label="Permalink to &quot;ZINCRBY&quot;">​</a></h3><p>为有序集 key 的成员 member 的 score 值加上增量 increment 。</p><p>可以通过传递一个负数值 increment ，让 score 减去相应的值，比如 ZINCRBY key -5 member ，就是让 member 的 score 值减去 5 。</p><p>当 key 不存在，或 member 不是 key 的成员时， ZINCRBY key increment member 等同于 ZADD key increment member 。</p><p>当 key 不是有序集类型时，返回一个错误。</p><p>score 值可以是整数值或双精度浮点数。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZINCRBY key increment member</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZSCORE salary tom</span></span>
<span class="line"><span>&quot;2000&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; ZINCRBY salary 2000 tom   # tom 加薪啦！</span></span>
<span class="line"><span>&quot;4000&quot;</span></span></code></pre></div><h3 id="zrange" tabindex="-1">ZRANGE <a class="header-anchor" href="#zrange" aria-label="Permalink to &quot;ZRANGE&quot;">​</a></h3><p>返回有序集 key 中，指定区间内的成员。</p><p>其中成员的位置按 score 值递增(从小到大)来排序。</p><p>具有相同 score 值的成员按字典序(lexicographical order )来排列。</p><p>如果你需要成员按 score 值递减(从大到小)来排列，请使用 ZREVRANGE 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZRANGE key start stop [WITHSCORES]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis &gt; ZRANGE salary 0 -1 WITHSCORES             # 显示整个有序集成员</span></span>
<span class="line"><span>1) &quot;jack&quot;</span></span>
...
<span class="line"><span>(empty list or set)</span></span></code></pre></div><h3 id="zrangebyscore" tabindex="-1">ZRANGEBYSCORE <a class="header-anchor" href="#zrangebyscore" aria-label="Permalink to &quot;ZRANGEBYSCORE&quot;">​</a></h3><p>返回有序集 key 中，所有 score 值介于 min 和 max 之间(包括等于 min 或 max )的成员。有序集成员按 score 值递增(从小到大)次序排列。</p><p>具有相同 score 值的成员按字典序(lexicographical order)来排列(该属性是有序集提供的，不需要额外的计算)。</p><p>可选的 LIMIT 参数指定返回结果的数量及区间(就像SQL中的 SELECT LIMIT offset, count )，注意当 offset 很大时，定位 offset 的操作可能需要遍历整个有序集，此过程最坏复杂度为 O(N) 时间。</p><p>区间及无限</p><p>min 和 max 可以是 -inf 和 +inf ，这样一来，你就可以在不知道有序集的最低和最高 score 值的情况下，使用 ZRANGEBYSCORE 这类命令。</p><p>默认情况下，区间的取值使用闭区间 (小于等于或大于等于)，你也可以通过给参数前增加 ( 符号来使用可选的开区间 (小于或大于)。</p><p>举个例子：</p><p>返回所有符合条件 1 &lt; score &lt;= 5 的成员，而</p><p>则返回所有符合条件 5 &lt; score &lt; 10 的成员。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZRANGEBYSCORE key min max [WITHSCORES] [LIMIT offset count]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZRANGEBYSCORE zset (1 5</span></span></code></pre></div><h3 id="zrank" tabindex="-1">ZRANK <a class="header-anchor" href="#zrank" aria-label="Permalink to &quot;ZRANK&quot;">​</a></h3><p>返回有序集 key 中成员 member 的排名。其中有序集成员按 score 值递增(从小到大)顺序排列。</p><p>排名以 0 为底，也就是说， score 值最小的成员排名为 0 。</p><p>使用 ZREVRANK 命令可以获得成员按 score 值递减(从大到小)排列的排名。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZRANK key member</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZRANGE salary 0 -1 WITHSCORES        # 显示所有成员及其 score 值</span></span>
...
<span class="line"><span>(integer) 1</span></span></code></pre></div><h3 id="zrem" tabindex="-1">ZREM <a class="header-anchor" href="#zrem" aria-label="Permalink to &quot;ZREM&quot;">​</a></h3><p>移除有序集 key 中的一个或多个成员，不存在的成员将被忽略。</p><p>当 key 存在但不是有序集类型时，返回一个错误。</p><p>Note</p><p>在 Redis 2.4 版本以前， ZREM 每次只能删除一个元素。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZREM key member [member ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 测试数据</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; ZRANGE page_rank 0 -1 WITHSCORES</span></span>
<span class="line"><span>1) &quot;bing.com&quot;</span></span>
<span class="line"><span>2) &quot;8&quot;</span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="zremrangebyrank" tabindex="-1">ZREMRANGEBYRANK <a class="header-anchor" href="#zremrangebyrank" aria-label="Permalink to &quot;ZREMRANGEBYRANK&quot;">​</a></h3><p>移除有序集 key 中，指定排名(rank)区间内的所有成员。</p><p>区间分别以下标参数 start 和 stop 指出，包含 start 和 stop 在内。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZREMRANGEBYRANK key start stop</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZADD salary 2000 jack</span></span>
<span class="line"><span>(integer) 1</span></span>
...
<span class="line"><span>1) &quot;tom&quot;</span></span>
<span class="line"><span>2) &quot;5000&quot;</span></span></code></pre></div><h3 id="zremrangebyscore" tabindex="-1">ZREMRANGEBYSCORE <a class="header-anchor" href="#zremrangebyscore" aria-label="Permalink to &quot;ZREMRANGEBYSCORE&quot;">​</a></h3><p>移除有序集 key 中，所有 score 值介于 min 和 max 之间(包括等于 min 或 max )的成员。</p><p>自版本2.1.6开始， score 值等于 min 或 max 的成员也可以不包括在内，详情请参见 ZRANGEBYSCORE 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZREMRANGEBYSCORE key min max</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZRANGE salary 0 -1 WITHSCORES          # 显示有序集内所有成员及其 score 值</span></span>
<span class="line"><span>1) &quot;tom&quot;</span></span>
<span class="line"><span>2) &quot;2000&quot;</span></span>
<span class="line"><span>3) &quot;peter&quot;</span></span>
<span class="line"><span>4) &quot;3500&quot;</span></span>
...
<span class="line"><span>1) &quot;jack&quot;</span></span>
<span class="line"><span>2) &quot;5000&quot;</span></span></code></pre></div><h3 id="zrevrange" tabindex="-1">ZREVRANGE <a class="header-anchor" href="#zrevrange" aria-label="Permalink to &quot;ZREVRANGE&quot;">​</a></h3><p>返回有序集 key 中，指定区间内的成员。</p><p>除了成员按 score 值递减的次序排列这一点外， ZREVRANGE 命令的其他方面和 ZRANGE 命令一样。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZREVRANGE key start stop [WITHSCORES]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZRANGE salary 0 -1 WITHSCORES        # 递增排列</span></span>
<span class="line"><span>1) &quot;peter&quot;</span></span>
<span class="line"><span>2) &quot;3500&quot;</span></span>
<span class="line"><span>3) &quot;tom&quot;</span></span>
<span class="line"><span>4) &quot;4000&quot;</span></span>
...
<span class="line"><span>6) &quot;3500&quot;</span></span></code></pre></div><h3 id="zrevrangebyscore" tabindex="-1">ZREVRANGEBYSCORE <a class="header-anchor" href="#zrevrangebyscore" aria-label="Permalink to &quot;ZREVRANGEBYSCORE&quot;">​</a></h3><p>返回有序集 key 中， score 值介于 max 和 min 之间(默认包括等于 max 或 min )的所有的成员。有序集成员按 score 值递减(从大到小)的次序排列。</p><p>具有相同 score 值的成员按字典序的逆序(reverse lexicographical order )排列。</p><p>除了成员按 score 值递减的次序排列这一点外， ZREVRANGEBYSCORE 命令的其他方面和 ZRANGEBYSCORE 命令一样。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZREVRANGEBYSCORE key max min [WITHSCORES] [LIMIT offset count]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis &gt; ZADD salary 10086 jack</span></span>
<span class="line"><span>(integer) 1</span></span>
<span class="line"><span>redis &gt; ZADD salary 5000 tom</span></span>
<span class="line"><span>(integer) 1</span></span>
...
<span class="line"><span>1) &quot;peter&quot;</span></span>
<span class="line"><span>2) &quot;tom&quot;</span></span>
<span class="line"><span>3) &quot;joe&quot;</span></span></code></pre></div><h3 id="zrevrank" tabindex="-1">ZREVRANK <a class="header-anchor" href="#zrevrank" aria-label="Permalink to &quot;ZREVRANK&quot;">​</a></h3><p>返回有序集 key 中成员 member 的排名。其中有序集成员按 score 值递减(从大到小)排序。</p><p>排名以 0 为底，也就是说， score 值最大的成员排名为 0 。</p><p>使用 ZRANK 命令可以获得成员按 score 值递增(从小到大)排列的排名。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZREVRANK key member</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis 127.0.0.1:6379&gt; ZRANGE salary 0 -1 WITHSCORES     # 测试数据</span></span>
<span class="line"><span>1) &quot;jack&quot;</span></span>
<span class="line"><span>2) &quot;2000&quot;</span></span>
<span class="line"><span>3) &quot;peter&quot;</span></span>
<span class="line"><span>4) &quot;3500&quot;</span></span>
...
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="zscore" tabindex="-1">ZSCORE <a class="header-anchor" href="#zscore" aria-label="Permalink to &quot;ZSCORE&quot;">​</a></h3><p>返回有序集 key 中，成员 member 的 score 值。</p><p>如果 member 元素不是有序集 key 的成员，或 key 不存在，返回 nil 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZSCORE key member</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZRANGE salary 0 -1 WITHSCORES    # 测试数据</span></span>
<span class="line"><span>1) &quot;tom&quot;</span></span>
<span class="line"><span>2) &quot;2000&quot;</span></span>
<span class="line"><span>3) &quot;peter&quot;</span></span>
<span class="line"><span>4) &quot;3500&quot;</span></span>
...
<span class="line"><span>&quot;3500&quot;</span></span></code></pre></div><h3 id="zunionstore" tabindex="-1">ZUNIONSTORE <a class="header-anchor" href="#zunionstore" aria-label="Permalink to &quot;ZUNIONSTORE&quot;">​</a></h3><p>计算给定的一个或多个有序集的并集，其中给定 key 的数量必须以 numkeys 参数指定，并将该并集(结果集)储存到 destination 。</p><p>默认情况下，结果集中某个成员的 score 值是所有给定集下该成员 score 值之 和 。</p><p>WEIGHTS</p><p>使用 WEIGHTS 选项，你可以为 每个 给定有序集 分别 指定一个乘法因子(multiplication factor)，每个给定有序集的所有成员的 score 值在传递给聚合函数(aggregation function)之前都要先乘以该有序集的因子。</p><p>如果没有指定 WEIGHTS 选项，乘法因子默认设置为 1 。</p><p>AGGREGATE</p><p>使用 AGGREGATE 选项，你可以指定并集的结果集的聚合方式。</p><p>默认使用的参数 SUM ，可以将所有集合中某个成员的 score 值之 和 作为结果集中该成员的 score 值；使用参数 MIN ，可以将所有集合中某个成员的 最小 score 值作为结果集中该成员的 score 值；而参数 MAX 则是将所有集合中某个成员的 最大 score 值作为结果集中该成员的 score 值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZUNIONSTORE destination numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE SUM|MIN|MAX]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ZRANGE programmer 0 -1 WITHSCORES</span></span>
<span class="line"><span>1) &quot;peter&quot;</span></span>
<span class="line"><span>2) &quot;2000&quot;</span></span>
<span class="line"><span>3) &quot;jack&quot;</span></span>
<span class="line"><span>4) &quot;3500&quot;</span></span>
...
<span class="line"><span>12) &quot;12000&quot;</span></span></code></pre></div><h3 id="zinterstore" tabindex="-1">ZINTERSTORE <a class="header-anchor" href="#zinterstore" aria-label="Permalink to &quot;ZINTERSTORE&quot;">​</a></h3><p>计算给定的一个或多个有序集的交集，其中给定 key 的数量必须以 numkeys 参数指定，并将该交集(结果集)储存到 destination 。</p><p>默认情况下，结果集中某个成员的 score 值是所有给定集下该成员 score 值之和.</p><p>关于 WEIGHTS 和 AGGREGATE 选项的描述，参见 ZUNIONSTORE 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ZINTERSTORE destination numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE SUM|MIN|MAX]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis &gt; ZADD mid_test 70 &quot;Li Lei&quot;</span></span>
<span class="line"><span>(integer) 1</span></span>
...
<span class="line"><span>5) &quot;Tom&quot;</span></span>
<span class="line"><span>6) &quot;199&quot;</span></span></code></pre></div><h3 id="zscan" tabindex="-1">ZSCAN <a class="header-anchor" href="#zscan" aria-label="Permalink to &quot;ZSCAN&quot;">​</a></h3><h2 id="pub-sub-发布-订阅" tabindex="-1">Pub/Sub（发布/订阅） <a class="header-anchor" href="#pub-sub-发布-订阅" aria-label="Permalink to &quot;Pub/Sub（发布/订阅）&quot;">​</a></h2><h3 id="psubscribe" tabindex="-1">PSUBSCRIBE <a class="header-anchor" href="#psubscribe" aria-label="Permalink to &quot;PSUBSCRIBE&quot;">​</a></h3><p>订阅一个或多个符合给定模式的频道。</p><p>每个模式以 * 作为匹配符，比如 it* 匹配所有以 it 开头的频道( it.news 、 it.blog 、 it.tweets 等等)， news.* 匹配所有以 news. 开头的频道( news.it 、 news.global.today 等等)，诸如此类。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PSUBSCRIBE pattern [pattern ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 订阅 news.* 和 tweet.* 两个模式</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>4) &quot;An apple a day, keep doctors away&quot;</span></span></code></pre></div><h3 id="publish" tabindex="-1">PUBLISH <a class="header-anchor" href="#publish" aria-label="Permalink to &quot;PUBLISH&quot;">​</a></h3><p>将信息 message 发送到指定的频道 channel 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PUBLISH channel message</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 对没有订阅者的频道发送信息</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>2) &quot;news.it&quot;</span></span></code></pre></div><h3 id="punsubscribe" tabindex="-1">PUNSUBSCRIBE <a class="header-anchor" href="#punsubscribe" aria-label="Permalink to &quot;PUNSUBSCRIBE&quot;">​</a></h3><h3 id="subscribe" tabindex="-1">SUBSCRIBE <a class="header-anchor" href="#subscribe" aria-label="Permalink to &quot;SUBSCRIBE&quot;">​</a></h3><p>订阅给定的一个或多个频道的信息。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SUBSCRIBE channel [channel ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 订阅 msg 和 chat_room 两个频道</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>2) &quot;chat_room&quot;</span></span>
<span class="line"><span>3) &quot;testing...haha&quot;</span></span></code></pre></div><h3 id="unsubscribe" tabindex="-1">UNSUBSCRIBE <a class="header-anchor" href="#unsubscribe" aria-label="Permalink to &quot;UNSUBSCRIBE&quot;">​</a></h3><h2 id="transaction-事务" tabindex="-1">Transaction（事务） <a class="header-anchor" href="#transaction-事务" aria-label="Permalink to &quot;Transaction（事务）&quot;">​</a></h2><h3 id="discard" tabindex="-1">DISCARD <a class="header-anchor" href="#discard" aria-label="Permalink to &quot;DISCARD&quot;">​</a></h3><p>取消事务，放弃执行事务块内的所有命令。</p><p>如果正在使用 WATCH 命令监视某个(或某些) key，那么取消所有监视，等同于执行命令 UNWATCH 。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DISCARD</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; MULTI</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>OK</span></span></code></pre></div><h3 id="exec" tabindex="-1">EXEC <a class="header-anchor" href="#exec" aria-label="Permalink to &quot;EXEC&quot;">​</a></h3><p>执行所有事务块内的命令。</p><p>假如某个(或某些) key 正处于 WATCH 命令的监视之下，且事务块中有和这个(或这些) key 相关的命令，那么 EXEC 命令只在这个(或这些) key 没有被其他命令所改动的情况下执行并生效，否则该事务被打断(abort)。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>EXEC</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 事务被成功执行</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; MULTI</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(nil)</span></span></code></pre></div><h3 id="multi" tabindex="-1">MULTI <a class="header-anchor" href="#multi" aria-label="Permalink to &quot;MULTI&quot;">​</a></h3><p>标记一个事务块的开始。</p><p>事务块内的多条命令会按照先后顺序被放进一个队列当中，最后由 EXEC 命令原子性(atomic)地执行。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>MULTI</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; MULTI            # 标记事务开始</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>&quot;hello moto&quot;</span></span></code></pre></div><h3 id="script-exists" tabindex="-1">SCRIPT EXISTS <a class="header-anchor" href="#script-exists" aria-label="Permalink to &quot;SCRIPT EXISTS&quot;">​</a></h3><p>给定一个或多个脚本的 SHA1 校验和，返回一个包含 0 和 1 的列表，表示校验和所指定的脚本是否已经被保存在缓存当中。</p><p>关于使用 Redis 对 Lua 脚本进行求值的更多信息，请参见 EVAL 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SCRIPT EXISTS script [script ...]</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SCRIPT LOAD &quot;return &#39;hello moto&#39;&quot;    # 载入一个脚本</span></span>
<span class="line"><span>&quot;232fd51614574cf0867b83d384a5e898cfd24e5a&quot;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; SCRIPT EXISTS 232fd51614574cf0867b83d384a5e898cfd24e5a</span></span>
<span class="line"><span>1) (integer) 0</span></span></code></pre></div><h3 id="script-flush" tabindex="-1">SCRIPT FLUSH <a class="header-anchor" href="#script-flush" aria-label="Permalink to &quot;SCRIPT FLUSH&quot;">​</a></h3><p>清除所有 Lua 脚本缓存。</p><p>关于使用 Redis 对 Lua 脚本进行求值的更多信息，请参见 EVAL 命令。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SCRIPT FLUSH</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SCRIPT FLUSH</span></span>
<span class="line"><span>OK</span></span></code></pre></div><h3 id="script-kill" tabindex="-1">SCRIPT KILL <a class="header-anchor" href="#script-kill" aria-label="Permalink to &quot;SCRIPT KILL&quot;">​</a></h3><p>杀死当前正在运行的 Lua 脚本，当且仅当这个脚本没有执行过任何写操作时，这个命令才生效。</p><p>这个命令主要用于终止运行时间过长的脚本，比如一个因为 BUG 而发生无限 loop 的脚本，诸如此类。</p><p>SCRIPT KILL 执行之后，当前正在运行的脚本会被杀死，执行这个脚本的客户端会从 EVAL 命令的阻塞当中退出，并收到一个错误作为返回值。</p><p>另一方面，假如当前正在运行的脚本已经执行过写操作，那么即使执行 SCRIPT KILL ，也无法将它杀死，因为这是违反 Lua 脚本的原子性执行原则的。在这种情况下，唯一可行的办法是使用 SHUTDOWN NOSAVE 命令，通过停止整个 Redis 进程来停止脚本的运行，并防止不完整(half-written)的信息被写入数据库中。</p><p>关于使用 Redis 对 Lua 脚本进行求值的更多信息，请参见 EVAL 命令。</p><p>以下是脚本被杀死之后，返回给执行脚本的客户端的错误：</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SCRIPT KILL</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 没有脚本在执行时</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>PONG</span></span></code></pre></div><h3 id="echo" tabindex="-1">ECHO <a class="header-anchor" href="#echo" aria-label="Permalink to &quot;ECHO&quot;">​</a></h3><p>打印一个特定的信息 message ，测试时使用。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ECHO message</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; ECHO &quot;Hello Moto&quot;</span></span>
<span class="line"><span>&quot;Hello Moto&quot;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; ECHO &quot;Goodbye Moto&quot;</span></span>
<span class="line"><span>&quot;Goodbye Moto&quot;</span></span></code></pre></div><h3 id="ping" tabindex="-1">PING <a class="header-anchor" href="#ping" aria-label="Permalink to &quot;PING&quot;">​</a></h3><p>使用客户端向 Redis 服务器发送一个 PING ，如果服务器运作正常的话，会返回一个 PONG 。</p><p>通常用于测试与服务器的连接是否仍然生效，或者用于测量延迟值。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PING</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 客户端和服务器连接正常</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; PING</span></span>
<span class="line"><span>PONG</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>Could not connect to Redis at 127.0.0.1:6379: Connection refused</span></span></code></pre></div><h3 id="quit" tabindex="-1">QUIT <a class="header-anchor" href="#quit" aria-label="Permalink to &quot;QUIT&quot;">​</a></h3><p>请求服务器关闭与当前客户端的连接。</p><p>一旦所有等待中的回复(如果有的话)顺利写入到客户端，连接就会被关闭。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>QUIT</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>$ redis</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; QUIT</span></span>
<span class="line"><span></span></span>
<span class="line"><span>$</span></span></code></pre></div><h3 id="select" tabindex="-1">SELECT <a class="header-anchor" href="#select" aria-label="Permalink to &quot;SELECT&quot;">​</a></h3><p>切换到指定的数据库，数据库索引号 index 用数字值指定，以 0 作为起始索引值。</p><p>默认使用 0 号数据库。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SELECT index</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SET db_number 0         # 默认使用 0 号数据库</span></span>
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>OK</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis[3]&gt;                      # 提示符从 [1] 改变成了 [3]</span></span></code></pre></div><h2 id="server-服务器" tabindex="-1">Server（服务器） <a class="header-anchor" href="#server-服务器" aria-label="Permalink to &quot;Server（服务器）&quot;">​</a></h2><h3 id="bgrewriteaof" tabindex="-1">BGREWRITEAOF <a class="header-anchor" href="#bgrewriteaof" aria-label="Permalink to &quot;BGREWRITEAOF&quot;">​</a></h3><p>执行一个 AOF文件 重写操作。重写会创建一个当前 AOF 文件的体积优化版本。</p><p>即使 BGREWRITEAOF 执行失败，也不会有任何数据丢失，因为旧的 AOF 文件在 BGREWRITEAOF 成功之前不会被修改。</p><p>重写操作只会在没有其他持久化工作在后台执行时被触发，也就是说：</p><p>从 Redis 2.4 开始， AOF 重写由 Redis 自行触发， BGREWRITEAOF 仅仅用于手动触发重写操作。</p><p>请移步 持久化文档(英文) 查看更多相关细节。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BGREWRITEAOF</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; BGREWRITEAOF</span></span>
<span class="line"><span>Background append only file rewriting started</span></span></code></pre></div><h3 id="bgsave" tabindex="-1">BGSAVE <a class="header-anchor" href="#bgsave" aria-label="Permalink to &quot;BGSAVE&quot;">​</a></h3><p>BGSAVE 命令执行之后立即返回 OK ，然后 Redis fork 出一个新子进程，原来的 Redis 进程(父进程)继续处理客户端请求，而子进程则负责将数据保存到磁盘，然后退出。</p><p>客户端可以通过 LASTSAVE 命令查看相关信息，判断 BGSAVE 命令是否执行成功。</p><p>请移步 持久化文档 查看更多相关细节。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>在后台异步(Asynchronously)保存当前数据库的数据到磁盘。</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; BGSAVE</span></span>
<span class="line"><span>Background saving started</span></span></code></pre></div><h3 id="client-getname" tabindex="-1">CLIENT GETNAME <a class="header-anchor" href="#client-getname" aria-label="Permalink to &quot;CLIENT GETNAME&quot;">​</a></h3><p>返回 CLIENT SETNAME 命令为连接设置的名字。</p><p>因为新创建的连接默认是没有名字的， 对于没有名字的连接， CLIENT GETNAME 返回空白回复。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CLIENT GETNAME</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 新连接默认没有名字</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis 127.0.0.1:6379&gt; CLIENT GETNAME</span></span>
<span class="line"><span>&quot;hello-world-connection&quot;</span></span></code></pre></div><h3 id="client-kill" tabindex="-1">CLIENT KILL <a class="header-anchor" href="#client-kill" aria-label="Permalink to &quot;CLIENT KILL&quot;">​</a></h3><p>关闭地址为 ip:port 的客户端。</p><p>ip:port 应该和 CLIENT LIST 命令输出的其中一行匹配。</p><p>因为 Redis 使用单线程设计，所以当 Redis 正在执行命令的时候，不会有客户端被断开连接。</p><p>如果要被断开连接的客户端正在执行命令，那么当这个命令执行之后，在发送下一个命令的时候，它就会收到一个网络错误，告知它自身的连接已被关闭。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CLIENT KILL ip:port</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 列出所有已连接客户端</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>10) &quot;1000&quot;</span></span></code></pre></div><h3 id="config-resetstat" tabindex="-1">CONFIG RESETSTAT <a class="header-anchor" href="#config-resetstat" aria-label="Permalink to &quot;CONFIG RESETSTAT&quot;">​</a></h3><p>重置 INFO 命令中的某些统计数据，包括：</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CONFIG RESETSTAT</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># 重置前</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>redis&gt; CONFIG GET slowlog-max-len</span></span>
<span class="line"><span>1) &quot;slowlog-max-len&quot;</span></span>
<span class="line"><span>2) &quot;10086&quot;</span></span></code></pre></div><h3 id="dbsize" tabindex="-1">DBSIZE <a class="header-anchor" href="#dbsize" aria-label="Permalink to &quot;DBSIZE&quot;">​</a></h3><p>返回当前数据库的 key 的数量。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DBSIZE</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; DBSIZE</span></span>
<span class="line"><span>(integer) 5</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; DBSIZE</span></span>
<span class="line"><span>(integer) 6</span></span></code></pre></div><h3 id="debug-object" tabindex="-1">DEBUG OBJECT <a class="header-anchor" href="#debug-object" aria-label="Permalink to &quot;DEBUG OBJECT&quot;">​</a></h3><p>DEBUG OBJECT 是一个调试命令，它不应被客户端所使用。</p><p>查看 OBJECT 命令获取更多信息。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DEBUG OBJECT key</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; DEBUG OBJECT my_pc</span></span>
...
<span class="line"><span>(error) ERR no such key</span></span></code></pre></div><h3 id="debug-segfault" tabindex="-1">DEBUG SEGFAULT <a class="header-anchor" href="#debug-segfault" aria-label="Permalink to &quot;DEBUG SEGFAULT&quot;">​</a></h3><p>执行一个不合法的内存访问从而让 Redis 崩溃，仅在开发时用于 BUG 模拟。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>DEBUG SEGFAULT</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; DEBUG SEGFAULT</span></span>
<span class="line"><span>Could not connect to Redis at: Connection refused</span></span>
<span class="line"><span></span></span>
<span class="line"><span>not connected&gt;</span></span></code></pre></div><h3 id="flushall" tabindex="-1">FLUSHALL <a class="header-anchor" href="#flushall" aria-label="Permalink to &quot;FLUSHALL&quot;">​</a></h3><p>清空整个 Redis 服务器的数据(删除所有数据库的所有 key )。</p><p>此命令从不失败。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>FLUSHALL</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; DBSIZE            # 0 号数据库的 key 数量</span></span>
<span class="line"><span>(integer) 9</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; DBSIZE</span></span>
<span class="line"><span>(integer) 0</span></span></code></pre></div><h3 id="flushdb" tabindex="-1">FLUSHDB <a class="header-anchor" href="#flushdb" aria-label="Permalink to &quot;FLUSHDB&quot;">​</a></h3><p>清空当前数据库中的所有 key。</p><p>此命令从不失败。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>FLUSHDB</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; DBSIZE    # 清空前的 key 数量</span></span>
<span class="line"><span>(integer) 4</span></span>
<span class="line"><span></span></span>
<span class="line"><span>redis&gt; FLUSHDB</span></span>
<span class="line"><span>OK</span></span>
...
<span class="line"><span>used_cpu_user_children:0.00</span></span>
<span class="line"><span></span></span>
<span class="line"><span># Keyspace</span></span></code></pre></div><h3 id="lastsave" tabindex="-1">LASTSAVE <a class="header-anchor" href="#lastsave" aria-label="Permalink to &quot;LASTSAVE&quot;">​</a></h3><p>返回最近一次 Redis 成功将数据保存到磁盘上的时间，以 UNIX 时间戳格式表示。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>LASTSAVE</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; LASTSAVE</span></span>
<span class="line"><span>(integer) 1324043588</span></span></code></pre></div><h3 id="monitor" tabindex="-1">MONITOR <a class="header-anchor" href="#monitor" aria-label="Permalink to &quot;MONITOR&quot;">​</a></h3><p>实时打印出 Redis 服务器接收到的命令，调试用。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>MONITOR</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>127.0.0.1:6379&gt; MONITOR</span></span>
<span class="line"><span>OK</span></span>
...
<span class="line"><span>1378822258.690131 [0 127.0.0.1:56604] &quot;DBSIZE&quot;</span></span></code></pre></div><h3 id="psync" tabindex="-1">PSYNC <a class="header-anchor" href="#psync" aria-label="Permalink to &quot;PSYNC&quot;">​</a></h3><p>用于复制功能(replication)的内部命令。</p><p>更多信息请参考 复制（Replication） 文档。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>PSYNC &lt;MASTER_RUN_ID&gt; &lt;OFFSET&gt;</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>127.0.0.1:6379&gt; PSYNC ? -1</span></span>
<span class="line"><span>&quot;REDIS0006\\xfe\\x00\\x00\\x02kk\\x02vv\\x00\\x03msg\\x05hello\\xff\\xc3\\x96P\\x12h\\bK\\xef&quot;</span></span></code></pre></div><h3 id="save" tabindex="-1">SAVE <a class="header-anchor" href="#save" aria-label="Permalink to &quot;SAVE&quot;">​</a></h3><p>SAVE 命令执行一个同步保存操作，将当前 Redis 实例的所有数据快照(snapshot)以 RDB 文件的形式保存到硬盘。</p><p>一般来说，在生产环境很少执行 SAVE 操作，因为它会阻塞所有客户端，保存数据库的任务通常由 BGSAVE 命令异步地执行。然而，如果负责保存数据的后台子进程不幸出现问题时， SAVE 可以作为保存数据的最后手段来使用。</p><p>请参考文档： Redis 的持久化运作方式(英文) 以获取更多消息。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SAVE</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; SAVE</span></span>
<span class="line"><span>OK</span></span></code></pre></div><h3 id="shutdown" tabindex="-1">SHUTDOWN <a class="header-anchor" href="#shutdown" aria-label="Permalink to &quot;SHUTDOWN&quot;">​</a></h3><p>SHUTDOWN 命令执行以下操作：</p><p>如果持久化被打开的话， SHUTDOWN 命令会保证服务器正常关闭而不丢失任何数据。</p><p>另一方面，假如只是单纯地执行 SAVE 命令，然后再执行 QUIT 命令，则没有这一保证 —— 因为在执行 SAVE 之后、执行 QUIT 之前的这段时间中间，其他客户端可能正在和服务器进行通讯，这时如果执行 QUIT 就会造成数据丢失。</p><p>SAVE 和 NOSAVE 修饰符</p><p>通过使用可选的修饰符，可以修改 SHUTDOWN 命令的表现。比如说：</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>SHUTDOWN</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; PING</span></span>
<span class="line"><span>PONG</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>(1.90s)</span></span></code></pre></div><h3 id="time" tabindex="-1">TIME <a class="header-anchor" href="#time" aria-label="Permalink to &quot;TIME&quot;">​</a></h3><p>返回当前服务器时间。</p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>TIME</span></span></code></pre></div><p><strong>示例</strong></p><div class="language-plaintext vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>redis&gt; TIME</span></span>
